...
void validateUser(BuildContext context) async{
  ...
  void buttonLoginTapped(BuildContext context) async {
            ...
            title: Column(
              ...
              children: <Widget>[
                new Row(
                  ...
                  children: [
                    GestureDetector(
                      child: Text("X", style: new TextStyle(fontSize: 26.0, color: Colors.grey),),
                      onTap: () =>Navigator.of(context).pop()
                      )
                  ],
                ),
                Text(screen3Login, style: new TextStyle(fontSize: 26.0, fontWeight: FontWeight.w800),),
                SizedBox(height:20.0),
                Text(screen3WelcomeBack , style: new TextStyle(fontSize: 22.0, color: Colors.grey)),
              ],
            ),
    ...
    return MaterialApp(
        ...
        body: new Column(
          children: [
            ...
            new Container(
              child: new Stack(  //we need the welcome text to be on top of the welcome image
                children: [
                  ...
                  Column( //welcome title & welcome body
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                  
                      Padding(
                        padding: const EdgeInsets.only(left: 20.0, top:100.0),
                        child: new Text(screen2WelcomeTitle, style: new TextStyle(fontSize: 26.0, fontWeight: FontWeight.w900),),
                      ),
                      ...
                      Padding(
                        ...
                        child: new Text(screen2WelcomeBody, style: new TextStyle(fontSize: 22.0, color: Colors.grey)),
                      ),
            ...
            //container: Signup & Login buttons
             Row(
              ...
              new Expanded(
                  ...
                  children: [
                    new Text("Already Have an Account?" , style: new TextStyle(fontWeight: FontWeight.w300, fontSize: 16.0),),
                    new SizedBox(width:10.0,),
                    GestureDetector(
                      onTap: () {buttonLoginTapped(context);},
                      child: new Text("LOGIN" , style: new TextStyle(fontWeight: FontWeight.w300, fontSize: 16.0, color: Colors.lightBlue, decoration: TextDecoration.underline,),)
                      ),
                  ],
                ),
              ),
