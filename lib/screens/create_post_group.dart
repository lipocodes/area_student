...
class CreatePostGroup extends StatefulWidget {
  ...
  CreatePostGroup(this.nameGroup);
  @override
  _CreatePostGroupState createState() => _CreatePostGroupState();
}

class _CreatePostGroupState extends State<CreatePostGroup> {
  ...
  String tag1 = "123456789", tag2 = "123456789", tag3 = "123456789";
    ...
    if (this.controllerPostText.text.toString().length == 0 &&
      ...
      await firebaseMethods.createNewPostGroup( this.controllerPostText.text,
      ...
      if (this.postImageList.length > 0) {
        await firebaseMethods.uploadPostGroupImages(this.postImageList, postId);
        List<String> imagesUrl = prefs.getStringList('imagesUrl');
        await firebaseMethod.updatePostsGroupsImages(widget.nameGroup,imagesUrl, postId, this.postsId);
      } else {
        await firebaseMethod
            .updatePostsGroupsImages(widget.nameGroup,['123456789'], postId, this.postsId);
      }
